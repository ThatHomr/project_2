...
class Pop_num_map :
    ...
    def initDataFrame(self):
        file_path = "./yearmonthapp/people_num/전력량_인구수_마커.csv"
    ...
    def setDataFrame(self, year_data, month_data) :
        ...
        self.df_data = self.df_ver[['시도', '인구수', '사용량', '위도', '경도']]
        self.df_data_test = self.df_data.to_dict(orient='records')

    def initJson(self) :
        jsonfile = open('./yearmonthapp/people_num/Sido.json','r',encoding='utf8').read()     
