...
class Factory_map :
    ...
    def initDataFrame(self):
        file_path = "./yearmapapp/factory/시도별_공장면적_전력_마커.csv"
    ...
    def setDataFrame(self, year_data) :
        ...
        self.df_data = self.df_ver[['시도', '사용량', '공장면적', '위도', '경도']]
        self.df_data_test = self.df_data.to_dict(orient='records')

    def initJson(self) :
        jsonfile = open('./yearmapapp/factory/Sido.json','r',encoding='utf8').read()     
    ...
    def map_base(self) :
        ...
        cho = folium.Choropleth(geo_data=self.jsondata_loc,              
                        ...
                        fill_color="YlGnBu",
                        key_on='feature.id',
                        legend_name='맵').add_to(self.factory_map)       
