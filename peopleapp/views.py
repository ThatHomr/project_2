...
from peopleapp.population_density.population_density_data_all import Data_all_View
from peopleapp.people_num.pop_num_map import Pop_num_map
from peopleapp.people_num.pop_graph import Data_num_View
from peopleapp.people_num.pop_graph_all import Data_num_all
...
def people_num(request) :
    ...
    return render(request, 'peopleapp/people_num.html', {"map_html" : map_html,
                                                         "data_view" : data_view,
                                                           "year_data" : year,
                                                           "month_data" : month,
                                                           "area_data" : area,
